...
Instrument.create(name: "Mapex Saturn Maple OR Walnut 4 Piece Pro Kit", description: "Maple and walnut hybrid shell drum kit consists of 3 Saturn V Drum Shells (Kick Drum, Floor Tom and Rack Tom), with a Black Panther Snare Drum", daily_rate: 44, store_id: s1.id, image_url:"", category: "drums")
